...
//    static const float freqs[] = {0.0625, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 1.0};
    ...
    */
     ...
     // experiment 3
    static const float sigmas[] = {1.25, 0.75, 0.25};
    static const float thetas[] = {0, 45, 90, 135};
    static const float freqs[] = {0.25, 0.5, 1.0};
...
void testApp::draw(){
    ...
    if (bNoiseState) {
        ...
        noiseShader.begin();
        noiseShader.setUniform1f("time", ofGetElapsedTimef() / 20.0f);
